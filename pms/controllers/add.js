...
AddController.saveBeanform=(req,res)=>{
  ...
  let sqlparams=[req.body.B_name,req.body.B_charger,req.body.B_unitId,req.body.B_chargerGender,req.body.B_chargerBrithday,req.body.B_chargerTitleId,req.body.B_telOffice,req.body.B_officeAddress,req.body.B_researchField,req.body.B_constructionPlan];
  _query(addsql,sqlparams,(err,result)=>{
    if(err){
      console.log(err);
    }
