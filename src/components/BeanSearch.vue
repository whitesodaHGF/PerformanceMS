<template>
  ...
  <form name="teamForm" method="post" action="/business/team/team.do">
      ...
      <el-tab-pane label="简单查询">    
        <table id="table" cellspacing="0" cellpadding="0" align="center">
            <tr>
              ...
              <el-input v-model="B_name" type='text' name='@name&like'  id='@name&like' size=40  maxLength = '100' ></el-input></div></td>
            </tr>
            <tr>
              ...
              <el-input v-model="B_chargerName" type='text' name='@chargerName'  id='@chargerName' size=40  maxLength = '40' ></el-input></div></td>
            </tr>
            <tr>
              <td class='tdrowhead' colspan=1 rowspan=1 width='15%'>所属单位：</td>
              <td class='list' colspan=1 rowspan=1 width='35%'><div id='team.unitId'>
                <el-input v-model="B_unitId" id='@unitId' type='text' name='@unitId' value='2c9081a345e057440145e072643e0009'></el-input></div></td>
            </tr>
            <tr>
              ...
              <td class='list' colspan=1 rowspan=1 width='35%'><div id='team.chargerGender'>	
                <el-radio v-model="B_chargerGender" name='@chargerGender' label="男" value="男"  >男</el-radio>
                <el-radio v-model="B_chargerGender" name='@chargerGender' label="女" value="女"  >女</el-radio>

            </div></td>
            </tr>
            <tr>
              <td class='tdrowhead' colspan=1 rowspan=1 width='15%'>出生日期：</td>
              <td class='list' colspan=3 rowspan=1><div id='team.chargerBrithday'>
                  <el-date-picker type='date' name='bean.createDate'  id='createDate' v-model="B_createDate"  placeholder="选择日期" suffix-icon="el-icon-date"  class="Wdate" ></el-date-picker>
                </div></td>
            </tr>
            <tr>
              ...
              <td class='list' colspan=1 rowspan=1 width='35%'><div id='team.chargerTitleId'>
                <el-select v-model="B_chargerTitleId"  name='bean.chargerTitleId' placeholder="请选择">
                      <el-option
              ...
              <td class='list' colspan=1 rowspan=1 width='35%'><div id='team.officeTel'> 
              <el-input type='text' v-model="B_officeTel"   id='@officeTel' size=0  maxLength = '20' ></el-input></div></td>
            
              </tr>
            <tr>
              <td class='tdrowhead' colspan=1 rowspan=1 width='15%'>办公地点：</td>
              <td class='list' colspan=3 rowspan=1><div id='team.officeAddress'> 
              <el-input type='text' v-model="B_officeAddress"   id='@officeAddress' size=30  maxLength = '100' ></el-input></div></td>
            </tr>
        ...
        <table id="table" cellspacing="0" cellpadding="0" align="center">
          <tr>
            ...
            <td class='list' colspan=1 rowspan=1><div id='team.researchField'> 
            <el-input type='text' v-model="B_researchField"  id='@researchField&like' size=70 ></el-input></div></td>
          </tr>
          <tr>
            <td class='tdrowhead' colspan=1 rowspan=1 width='15%'>建设规划：</td>
            <td class='list' colspan=1 rowspan=1><div id='team.constructionPlan'> 
              <el-input type='text' v-model="B_constructionPlan"  id='@constructionPlan&like' size=70 ></el-input></div></td>
          </tr>
        </table>
      </el-tab-pane>
    </el-tabs>
                ...
                <table id="table" cellspacing="0" cellpadding="0" align="center">
                  <tr>
                    <td height="23" class="list" width="15%">
                      <el-select v-model="B_orderField"  name='bean.orderField' placeholder="请选择">
                        <el-option
                        v-for="item in B_orderFields"
                        :key="item.value"
                        :label="item.label"
                        :value="item.value">
                        </el-option>
                    ...
                    <td height="23" class="list" width="85%" colspan="3">
                      <el-radio v-model="B_isdownsort" label="降序" value="降序"></el-radio>
                      <el-radio v-model="B_isdownsort" label="升序" value="升序"></el-radio>
                    </td>
                  </tr>
                </table>
          </el-card>
  ...
  export default {
    data() {
      return {
        ...
        B_orderFields:[
          { value:'',label:'--请选择--'
          },{ value:'团队名称',label:'团队名称'
          },{ value:'带头人',label:'带头人'
          },{ value:'所属单位',label:'所属单位'
          },{ value:'带头人性别',label:'带头人性别'
          },{ value:'出生日期',label:'出生日期'
          },{ value:'职称',label:'职称'
          },{ value:'办公电话',label:'办公电话'
