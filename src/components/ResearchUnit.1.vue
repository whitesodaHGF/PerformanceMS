<template>
	<el-card class="box-card">
		...
		<div slot="header" class="clearfix">
			...
			<!-- <el-button size="large"  style="float:right;" @click="getUnitinfo">获取</el-button> -->
			...
			<el-button size="large"  style="float:right;" @click="saveUnitinfo">保存</el-button>
		</div>
		<!-- mainbg -->
		<div class="mainbg">
				...
				<el-row>
					<el-col :span=12 :push=4 >
						<el-form-item label="机构名称：">
								<el-input v-model="Unitform[0].R_name" type='text' name='bean.name'  id='name' size='50' maxLength = '100' ></el-input>
								<font color=red> *</font>
						</el-form-item>
					</el-col>
					<el-col :span=12 >
						<el-form-item label="机构编号：">
								<el-input v-model="Unitform[0].R_code" type='text' name='bean.code'  id='code' size='0' maxLength = '64' ></el-input>
								<font color=red> *</font>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
					<el-col :span=12 :push=4 >
						<el-form-item label="负责人：">
								<el-input v-model="Unitform[0].R_charger" type='text' name='bean.charger'  id='charger' size='0' maxLength = '40' ></el-input>
						</el-form-item>
					</el-col>
					<el-col :span=12 >
				...
				<el-row>
					...
					<el-col :span=12 >
						<el-form-item label="机构级别：">
							...
							<el-radio v-model="Unitform[0].R_levelId" name='bean.levelId' label="省部级" value='省部级' >省部级</el-radio>
				...
				<el-row>
					<el-col :span=12 :push=4 >
						<el-form-item label="电话：">
							<el-input v-model="Unitform[0].R_telOffice" type='text' name='bean.tel'  id='tel' size='0'    maxLength = '128'></el-input>
						</el-form-item>
					</el-col>
					<el-col :span=12 >
						<el-form-item label="传真：">
							<el-input v-model="Unitform[0].R_fax" type='text' name='bean.fax'  id='fax' size='0'    maxLength = '128'></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
					<el-col :span=12 :push=4 >
						<el-form-item label="地址：">
							<el-input v-model="Unitform[0].R_address" type='text' name='bean.address'  id='address' size='0'    maxLength = '255' ></el-input>
						</el-form-item>
					</el-col>
					<el-col :span=12 >
						<el-form-item label="邮编：">
							<el-input v-model="Unitform[0].R_postalCode" type='text' name='bean.postalCode'  id='postalCode' size='0'   maxlength="6" ></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
					<el-col :span=12 :push=4 >
						<el-form-item label="Email：">
							<el-input v-model="Unitform[0].R_email" type='email' name='bean.email'  id='email' size='0'    maxLength = '128' ></el-input>
						</el-form-item>
					</el-col>
					<el-col :span=12 >
						<el-form-item label="网址：">
							<el-input v-model="Unitform[0].R_website" type='text' name='bean.website'  id='website' size='0'    maxLength = '128' ></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
					<el-col :span=12 :push=4 >
						<el-form-item label="成立日期：">
							<el-date-picker 
								...
								name='bean.createDate'  
								id='createDate' 
								v-model="Unitform[0].R_createDate" 
